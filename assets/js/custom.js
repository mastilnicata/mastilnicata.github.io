	...
	$(window).scroll(function() {
		...
		//window.onscroll = () => {
		  ...
		  sections.each((section_index) => {
			...
			console.log("scrollY:" + scrollY + " :: sectionTop:" + sectionTop)
	  ...
	  if (scroll >= header) {
		//console.log("[addclass] scroll: " + scroll + ", box: " + box + ", header: " + header + ", box - header: "+ (box - header)  +", (scroll >= box - header): " + (scroll >= box - header) );
	    $("header").addClass("background-header");
		gobackup.fadeIn(500);
		subheader.fadeIn(200);
	  } else {
		//console.log("[remclass] scroll: " + scroll + ", box: " + box + ", header: " + header + ", box - header: "+ (box - header)  +", (scroll >= box - header): " + (scroll >= box - header) );
